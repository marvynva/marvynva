<h1 align="center">Hola 👋, Soy Marvyn Verde</h1>
...
<ul>
  <li>Lenguajes de programacion: Html5, Css3, Sass, Javascript, NodeJs, ReactJS, Angular, Express, NestJs.</li>
  <li>Bases de datos: Mongo db, Firebase.</li>
  <li>Gestor de bases de datos: Mysql y SqlServer.</li>
  <li>Herramientas: Postman, Thunder Client.</li>
  <li>Control de versión con git y plataformas como Github, Gitlab. </li>
  <li>Contenerizacion: Docker.</li>
  <li>Experiencia en trabajo con metodologías ágiles (SCRUM).</li>
</ul>
